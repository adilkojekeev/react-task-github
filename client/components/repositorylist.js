...
const Repositorylist = (props) => {
  ...
  return (
    <div className="">
      <div>
        <table className="repo-table w-full text-left ">
          <thead className="table-head">
            <tr>
              <th className="p-2 rounded-t-lg text-xl ">Repos name</th>
              <th className="p-2 rounded-t-lg text-xl ">Language</th>
              <th className="p-2 rounded-t-lg text-xl ">Created</th>
              <th className="p-2 rounded-t-lg text-xl ">Fork</th>
              <th className="p-2 rounded-t-lg text-xl ">View readme</th>
            </tr>
          </thead>
              ...
              <tr key={rep.id}>
                ...
                <td>
                  <Link to={`/${props.userName}/${rep.name}`}>
                    <a href="#" className=" hover:text-green-500 py-2 px-4 rounded-full ">
                      View readme
                    </a>
                  </Link>
                </td>
